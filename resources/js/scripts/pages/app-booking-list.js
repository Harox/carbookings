    ...
    dtUserTable.DataTable({
      ...
      initComplete: function () {
        ...
        this.api()
          ...
          .every(function () {
            var column = this;
            var label = $('<label class="form-label" for="UserRole">Data</label>').appendTo('.user_role');
            var select = $(
        ...
        this.api()
          ...
          .every(function () {
            var column = this;
            var label = $('<label class="form-label" for="FilterTransaction">Etados</label>').appendTo('.user_status');
            var select = $(
