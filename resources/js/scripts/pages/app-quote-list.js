...
$(function () {
  ...
  if ($('body').attr('data-framework') === 'laravel') {
    ...
    invoiceAdd = assetPath + 'admin/quote/add';
    invoiceEdit = assetPath + 'admin/quote/edit';
  }

  // datatable
  if (dtInvoiceTable.length) {
    var dtInvoice = dtInvoiceTable.DataTable({
      ajax: assetPath + 'data/quote-list.json', // JSON file to add data
      autoWidth: false,
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              $invoiceStatus +
              '<br> <span class="fw-bold">Saldo:</span> ' +
              $balance +
              '<br> <span class="fw-bold">validade:</span> ' +
              $dueDate +
              "</span>'>" +
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return '<span class="d-none">' + $total + '</span>MZN ' + $total;
          }
        },
        {
          // Due Date
      ...
      language: {
        ...
        search: 'Pesquisar',
        searchPlaceholder: 'Pesquisar Cotação',
        paginate: {
      ...
      initComplete: function () {
        ...
        this.api()
          ...
          .every(function () {
            var column = this;
            var select = $(
              '<select id="UserRole" class="form-select ms-50 text-capitalize"><option value=""> Estado </option></select>'
            )
